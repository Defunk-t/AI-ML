# Trains a model to predict whether IMDB movie review sentiment
# is positive or negative - a binary classification problem
...
# are organised into folders by class. There is a 'pos' (positive) and
# a 'neg' (negative) folder. There is also a 'unsup' (unsupervised)
# folder which isn't needed, so it should be deleted so the function
# doesn't import it.
